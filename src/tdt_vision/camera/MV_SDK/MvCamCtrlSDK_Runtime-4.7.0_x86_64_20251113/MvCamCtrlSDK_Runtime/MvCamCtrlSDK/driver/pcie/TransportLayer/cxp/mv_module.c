...
struct pci_device_id CxpDeviceId[] = {
    ...
    {CXP_VENDOR_ID, CXP6_GX1008_DEVICE_ID, CXP_VENDOR_ID, CXP6_OCTA_SUBDEVICE_ID, 0, 0, 0},
    {CXP_VENDOR_ID, CXP6_GX1104_DEVICE_ID, CXP_VENDOR_ID, CXP6_QUAD_SUBDEVICE_ID, 0, 0, 0},
    {CXP_VENDOR_ID, CXP6_GX1102_DEVICE_ID, CXP_VENDOR_ID, CXP6_DUAL_SUBDEVICE_ID, 0, 0, 0},
    {0,}
};
