...
int MV_DmaSgGetSclistLength(void* pSclist)
{
    if (NULL == pSclist)
    {
     ...
     return sg_dma_len((struct scatterlist*)pSclist);
}
...
unsigned long MV_DmaSgGetSclistAddr(void* pSclist)
{
    ...
    return (unsigned long)sg_dma_address((struct scatterlist*)pSclist);
}
...
int MV_DmaSgSetSclistLength(void* pSclist, int nSgElemLen)
{
    ...
    sg_dma_len((struct scatterlist*)pSclist) = nSgElemLen;
    return nRet;
}
...
int MV_DmaSgSetSclistAddrOffset(void* pSclist, unsigned long nAddr)
{
    ...
    sg_dma_address((struct scatterlist*)pSclist) = nAddr;
    return nRet;
}
...
struct scatterlist * MV_DmaSgGetNextSgElem(void* pSclist)
{
    ...
    return sg_next((struct scatterlist*)pSclist);
}
